...
var autowoot;
/*
 * Whether the user has currently enabled auto-woot timer.
 */
var timer = true;
/*
...
function initUIListeners() 
{
    ...
    $('#plugbot-btn-woot').on('click', function() 
    {
        ...
        {
            //if(timer){
                setTimeout(function(){$('#button-vote-positive').click()},Math.floor(Math.random()*15)+20);
            //}else{
    ...
    /*
     * Toggle auto-woot timer.
     */
    $('#plugbot-btn-timer').on('click', function() 
    {
        timer = !timer;
